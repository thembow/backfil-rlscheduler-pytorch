...
def ppo(workload_file, model_path, ac_kwargs=dict(), seed=0, 
    ...
    env = HPCEnv(shuffle=shuffle, backfil=backfil, skip=skip, job_score_type=score_type, batch_job_slice=batch_job_slice, build_sjf=True, heuristic=heuristic, enable_preworkloads=enable_preworkloads)
    env.seed(seed)
